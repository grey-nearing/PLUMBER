...
for s = 1:Ns
 ...
 for m = 1:Nm
  ...
  for l = 1:Nl
   ...
   fname = strcat('results/models/PALS_',siteNames{s},'_',modelNames{m},'_',num2str(l),'.txt');
   saveCircos(T,varNames,Du,D,fname);

   % save in Circos format
   TT = T./H; 
   fname = strcat('results/models/PALS_Normalized_',siteNames{s},'_',modelNames{m},'_',num2str(l),'.txt');
